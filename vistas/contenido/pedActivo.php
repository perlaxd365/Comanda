			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li ><a href="index_2.php">Inicio</a>
								<li><a href="pedActivo.php"><a href="#">Nuevos Pedidos</a>
								<li><a href="pedActivo.php">Pedidos Activos</a>
								<li><a href="#">Mesas Disponibles</a>
								</li>
								<li>
									<div class="header-icons">
										<a class="shopping-cart" href="index.php"><i class="fas fa-door-closed"></i></a>
				...
				<div class="col-lg-8">
					<div class="checkout-accordion-wrap">
						...
						<div class="cart-buttons">
							<a href="selProducto.php" class="boxed-btn">Agregar</a>
							<a href="index_2.php" class="boxed-btn black">Eliminar</a>
							<a href="index_2.php" class="boxed-btn black">Enviar</a>
						</div>
